...
// This file has been altered from edu.wpi.first.math.kinematics.MecanumDriveKinematics
// to include a scalar in ::toTwist2d()
 ...
 * uses the relative locations of the wheels with respect to the center of
 * rotation. The center of
 * rotation for inverse kinematics is also variable. This means that you can set
 * your center of
 ...
 *
 * <p>
 * The inverse kinematics: [wheelSpeeds] = [wheelLocations] * [chassisSpeeds] We
 * take the
 * Moore-Penrose pseudoinverse of [wheelLocations] and then multiply by
 * [wheelSpeeds] to get our
 * chassis speeds.
 *
 * <p>
 ...
 */
public class CustomMecanumDriveKinematics extends MecanumDriveKinematics
...
// StructSerializable
{
   ...
   *
   * @param frontLeftWheelMeters  The location of the front-left wheel relative to
   *                              the physical
   *                              center of the robot.
   * @param frontRightWheelMeters The location of the front-right wheel relative
   *                              to the physical
   *                              center of the robot.
   * @param rearLeftWheelMeters   The location of the rear-left wheel relative to
   *                              the physical center
   *                              of the robot.
   * @param rearRightWheelMeters  The location of the rear-right wheel relative to
   *                              the physical
   *                              center of the robot.
   */
  public CustomMecanumDriveKinematics(
    ...
    this.xScalar = 1 / xScalar;
    this.yScalar = 1 / yScalar;
   ...
   *         Sometimes, a user input
   *         may cause one of the wheel speeds to go above the attainable max
   *         velocity. Use the {@link
   *         MecanumDriveWheelSpeeds#desaturate(double)} function to rectify this
   *         issue.
   */
   ...
   * {@link #toWheelSpeeds(ChassisSpeeds, Translation2d)} for more
   * information.
   *
   * @param chassisSpeeds The desired chassis speed.
   ...
   * wheel deltas. This
   * method is often used for odometry -- determining the robot's position on the
   * field using
   ...
   *           center of the robot.
   * @param rl The location of the rear-left wheel relative to the physical center
   *           of the robot.
  ...
  private void setInverseKinematics(
    ...
    m_inverseKinematics.setRow(0, 0, xScalar, -yScalar, -(fl.getX() + fl.getY()));
    m_inverseKinematics.setRow(1, 0, xScalar, yScalar, fr.getX() - fr.getY());
    m_inverseKinematics.setRow(2, 0, xScalar, yScalar, rl.getX() - rl.getY());
    m_inverseKinematics.setRow(3, 0, xScalar, -yScalar, -(rr.getX() + rr.getY()));
  }
